...
public class BeatIndexConstants {
	static int startDate = 20140101;
	static int endDate = 20150101;
	...
	static boolean useIntradays = false; // get intradays from the properties file
	static double startBedrag = 1000000d;
